...
def main():
    ...
    #path="/home/rahul/Dropbox/MyWork/RAN_CRBMv1.0/data/iris_with_label.csv"
        ...
        for iter1 in range(1,10):
            ...
            #for train, test in kf.split(rawData):
                ...
                mlp = MLPClassifier( random_state=1,
                                        hidden_layer_sizes=(10), max_iter=250)
                ...
                logreg=LogisticRegression(multi_class='multinomial',solver='newton-cg',max_iter=5,class_weight='balanced',C=0.0001)
                ...
                sgd = SGDClassifier(alpha=0.00001,n_iter=2,epsilon=0.25)
